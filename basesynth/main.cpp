...
//
// This is a template for creating a pedal on the GuitarML Funbox_v3/Daisy Seed
// platform. You can start from here to fill out your effects processing and
// controls. Allows for Stereo In/Out, 6 knobs, 3 3-way switches, 4 dipswitches,
// 2 SPST Footswitches, 2 LEDs.
//
// Keith Bloemer 06/12/2024
// Bruno Croci   16/11/2025
//

using namespace daisy;
using namespace daisysp;

// This is important for mapping the correct controls to
// the Daisy Seed on Funbox PCB
...
void UpdateSwitches()
{
  // Detect any changes in switch positions (3 On-Off-On switches and Dip
  // switches)
